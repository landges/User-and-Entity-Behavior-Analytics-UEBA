...
from keras.layers import Dense, Activation, Embedding, Conv2D, MaxPooling2D, Reshape, BatchNormalization, Dropout, \
    Input, concatenate, GlobalAveragePooling2D, Flatten, ConvLSTM2D, LSTM, Conv3D
...
if __name__ == "__main__":
    ...
    print('TPR: ', tpr)
    # --------------base line 
    baseline_fpr = [0, 0.03703704, 0.03803704, 0.04703704, 0.06407407, 0.07407407, 0.07407407, 0.11111111, 0.11311111,
                    0.14814815, 0.15814815, 0.35564815, 0.46444444, 0.46444444, 1]
    baseline_tpr = [0, 0.16184971, 0.26184971, 0.26184971, 0.63815029, 0.83815029, 0.83815029, 0.88265896, 0.88265896,
                    0.88265896, 0.98643931, 0.99321965, 0.99321965, 1, 1]
