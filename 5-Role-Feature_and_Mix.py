...
def role_feature():
    ...
    user_sets = ['ASD0577', 'AAL0706', 'ASM0575', 'GCG0951', 'AAV0450', 'TDG0962', 'CCM0136', 'FRR0832', 'KPP0452',
                 'ABM0845', 'MJB0588', 'WJD0576', 'ILH0958', 'FEB0306', 'JJB0700', 'AHD0848', 'LDM0587', 'MLG0475',
                 'NCK0295', 'YJV0699', ]
...
if __name__ == "__main__":
    ...
    # ----- step 3 拼接的数据进行标签 (然后根据CERT数据集中的恶意行为进行标签的修正) Generate the label according to the source data -------  the
    # number behind the user is the firt day that the users' anomalous behavior is emerging accoriding to the source
    # data in CERT dataset ------------
