...
def log_feature(file_input):
    ...
    for line in files_in:
        ...
        if line != '\n':
            ...
            data_list = [numebr_logon, first_logon_hour, first_logon_minutes, first_logoff_hour, first_logoff_minutes,
                         last_logon_hour, last_logon_minutes, last_logoff_hour, last_logoff_minutes, online_time]
    ...
    for line in files_in:
        if line != '\n':
            ...
            for i in range(len(line)):
                ...
                # 数据拼接
                data_email = data_email + [Number_receiver, source_email_type, Number_company_email,
                                           Number_private_email, size_email, attachment_count]
